            ...
            <div class="col-md-8">
                ...
                <div class="h-b-left-relative">
                    <div class="owl-carousel owl-theme h-b-owl">
                        ...
                        <div class="one-item">
                            <div class="col-md-12 pb-2">
                                <a class="fancybox" data-caption="Tủ Điện Chung Cư" data-fancybox="gallery-cus"
                                   href="{{url('/').'/images/project/13.jpg'}}">{{ Html::image('images/project/13.jpg','',array('class'=>'img-one-project')) }}
                                </a>
                            </div>
                            <div class="col-md-12 pb-2">
                                <a class="fancybox" data-caption="Làm Cho Nhà Dân" data-fancybox="gallery-cus"
                                   href="{{url('/').'/images/project/14.jpg'}}">{{ Html::image('images/project/14.jpg','',array('class'=>'img-one-project')) }}
                                </a>
                            </div>
                        </div>
                        <div class="one-item">
                            <div class="col-md-12 pb-2">
                                <a class="fancybox" data-caption="Làm Cho Nhà Dân" data-fancybox="gallery-cus"
                                   href="{{url('/').'/images/project/15.jpg'}}">{{ Html::image('images/project/15.jpg','',array('class'=>'img-one-project')) }}
                                </a>
                            </div>
                            <div class="col-md-12 pb-2">
                                <a class="fancybox" data-caption="Làm Cho Nhà Dân" data-fancybox="gallery-cus"
                                   href="{{url('/').'/images/project/16.jpg'}}">{{ Html::image('images/project/16.jpg','',array('class'=>'img-one-project')) }}
                                </a>
                            </div>
                        </div>
                        <div class="one-item">
                            <div class="col-md-12 pb-2">
                                <a class="fancybox" data-caption="Làm Cho Nhà Dân" data-fancybox="gallery-cus"
                                   href="{{url('/').'/images/project/17.jpg'}}">{{ Html::image('images/project/17.jpg','',array('class'=>'img-one-project')) }}
                                </a>
                            </div>
                            <div class="col-md-12 pb-2">
                                <a class="fancybox" data-caption="Làm Cho Nhà Dân" data-fancybox="gallery-cus"
